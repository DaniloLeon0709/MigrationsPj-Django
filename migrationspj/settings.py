"""
Django settings for migrationspj project.
...
SECRET_KEY = 'django-insecure-j=r9rpx(o3nb(i&_j$x=kk6(api4*!t1nj7pqr9)5&m@mu9@95'
...
WSGI_APPLICATION = 'migrationspj.wsgi.application'
